...
class GBasic {
   ...
   public:
     ...
     */
    GBasic(short steps, short dir_pin, short step_pin, Shiftduino& param, int index);
    GBasic(short steps, short dir_pin, short step_pin, short enable_pin, Shiftduino& param, int index);
    GBasic(short steps,
           short dir_pin,
           short step_pin,
           short mode0_pin,
